MODEL_NAME='penet_rwt_hp_model/'
CHCEKPOINTS_PATH='your_model_path'
DATASETS='VG'
NUM_GPUS=1
CUDA_VISIBLE_DEVICES=0
PREDICTOR='PeNet_HP_Predictor'
...
MODEL.ROI_RELATION_HEAD.HP.A1 0.0 \
MODEL.ROI_RELATION_HEAD.HP.A2 0.0 \
MODEL.ROI_RELATION_HEAD.REL_NMS True
